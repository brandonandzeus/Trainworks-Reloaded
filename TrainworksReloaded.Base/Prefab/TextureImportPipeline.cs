...
namespace TrainworksReloaded.Base.Prefab
{
    public class TextureImportPipeline : IDataPipeline<IRegister<GameObject>>
    {
        ...
        public void Run(IRegister<GameObject> service)
        {
            ...
            {
                foreach (var texture in config.Value.Configuration.GetSection("textures").GetChildren())
                {
                    ...
                    foreach(var directory in config.Value.AssetDirectories)
                    {
                        ...
                        var sprite = Sprite.Create(texture2d, new Rect(0, 0, texture2d.width, texture2d.height), new Vector2(0.5f, 0.5f), 128f);
                        image.sprite = sprite;
                        ...
                        var cardEffectTransforms = new GameObject
                        {
                            name = "CardEffectTransforms"
                        };
